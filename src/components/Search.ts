...
export const Search = (
  ...
  input.className =
    "w-full h-full border-2 border-primary rounded-[10px] 2xs:rounded-[12px] xs:rounded-[16px] sm:rounded-[18px] md:rounded-[22px] lg:rounded-[20px] xl:rounded-[30px] bg-card " +
