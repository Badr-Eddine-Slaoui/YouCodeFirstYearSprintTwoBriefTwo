...
export const GameDetails = (params?: Record<string, string>): HTMLElement => {
  ...
  const render = (): void => {
    container.innerHTML = "";
    container.className =
      "mt-[6vh] pb-5 2xs:mt-[8vh] xs:mt-[9vh] sm:mt-[10vh] md:mt-[12vh] lg:mt-[14vh] xl:mt-[16vh]";
    const imageContainer = document.createElement("div") as HTMLDivElement;
    imageContainer.className =
      "flex w-full h-[30vh] items-center justify-center sm:h-[40vh] md:h-[50vh] lg:h-[60vh] xl:h-[85vh]";
    ...
    gameDetails.className =
      "p-4 w-[90%] border border-card mx-auto relative top-[-8vh] min-h-[20vh] bg-light-card dark:bg-card rounded-[15px] bg-opacity-80 z-[1] text-[0.8rem] 2xs:text-[1rem] xs:text-[1.2rem] sm:p-6 sm:text-[1.4rem] md:text-[1.6rem] lg:text-[1.4rem] lg:p-8 xl:text-[1.6rem]";
    container.append(gameDetails);

    const title = document.createElement("h1") as HTMLDivElement;
    title.className =
      "font-extrabold mb-6 text-[1.2rem] 2xs:text-[1.4rem] xs:text-[1.6rem] sm:text-[1.8rem] md:text-[2rem] lg:text-[1.8rem] xl:text-[2rem]";
    ...
    game.genres.forEach((genre: any) => {
      ...
      genreEl.className =
        "text-light-primary dark:text-primary text-bold text-card rounded-full text-center bg-opacity-30 min-w-12 px-3 py-1 sm:px-4 sm:py-2 xl:px-5 xl:py-3";
    ...
    platformsContainer.className =
      "flex flex-wrap my-5 gap-4 text-[0.8rem] 2xs:text-[1rem] 2xs:gap-y-4 2xs:gap-x-8 xs:text-[1.2rem] sm:text-[1.4rem] sm:gap-y-4 sm:gap-x-10 md:text-[1.6rem] lg:text-[1.4rem] xl:text-[1.6rem] xl:gap-y-4 xl:gap-x-12";
    ...
    ratingContainer.className =
      "flex flex-col justify-start gap-y-2 items-center max-w-14 2xs:max-w-19 sm:max-w-32 text-center";
    ...
    ratingIcon.className =
      "w-[4vh] h-[4vh] text-light-primary dark:text-primary bg-light-card dark:bg-card rounded-full flex items-center justify-center";
    ...
    gameAbout.className =
      "p-4 w-[90%] border border-card mx-auto relative top-[-4vh] min-h-[30vh] bg-light-card dark:bg-card rounded-[15px] bg-opacity-80 text-[0.8rem] 2xs:text-[1rem] xs:text-[1.2rem] sm:p-6 sm:text-[1.4rem] md:text-[1.6rem] lg:text-[1.4rem] lg:p-8 xl:text-[1.6rem]";
    ...
    aboutText.className = "font-bold text-light-secondary dark:text-secondary";
    aboutText.textContent = game.description;
    gameAbout.append(aboutText);

    const infos = document.createElement("div") as HTMLDivElement;
    infos.className =
      "p-4 w-[90%] border border-card mx-auto min-h-[10vh] bg-light-card dark:bg-card rounded-[15px] bg-opacity-80 text-[0.8rem] 2xs:text-[1rem] xs:text-[1.2rem] sm:text-[1.4rem] sm:p-6 md:text-[1.6rem] lg:text-[1.4rem] lg:p-8 xl:text-[1.6rem]";
    ...
    publishersText.className =
      "font-bold text-light-secondary dark:text-secondary";
    ...
    publishers.className = "font-bold text-light-primary dark:text-primary";
    publishers.textContent = game.publishers
    ...
    developers.className = "font-bold text-light-primary dark:text-primary";
    developers.textContent = game.developers
  ...
  const renderFavoritesBtn = (): void => {
    ...
    favoriteBtn.className =
      "w-[90%] mx-auto my-[4vh] flex justify-center items-center px-6 py-3 font-bold text-primary bg-blue-500 text-[0.8rem] 2xs:text-[1rem] xs:text-[1.2rem] sm:text-[1.4rem] md:text-[1.6rem] lg:text-[1.4rem] lg:py-5 xl:text-[1.6rem] rounded-[30px]";
    ...
    favoritesText.textContent = isFavorite(game)
  ...
  makeEffect(async () => {
    try {
      ...
      loadingScreen.classList.add("h-screen");
      container.append(loadingScreen);
      const response = await fetch(
        `https://debuggers-games-api.duckdns.org/api/games/${id}`
      );
